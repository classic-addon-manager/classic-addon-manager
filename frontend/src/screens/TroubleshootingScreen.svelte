<script lang="ts">
  ...
  import {getInstalledAddons} from '$atoms/addon.svelte'
  ...
  import {type Addon, LocalAddonService, type LogParseResult} from '$lib/wails'
    ...
    <div class="container px-4 py-6">
      <div class="mx-auto max-w-3xl">
        <Accordion.Root type="single" class="space-y-4">
          ...
          }, {id: 'item-3', title: 'Diagnostic Results'}] as item (item.id)}
                  ...
                  <div transition:slide={{duration: 200, easing: cubicOut}}
                    ...
                    {:else}
                      <ScrollArea class="rounded-lg border border-zinc-700">
                        {#each Object.keys(groupedIssues) as addonName (addonName)}
                          <Collapsible.Root class="border-b border-zinc-700 last:border-0">
                            ...
                            <Collapsible.Content>
                              <div transition:slide={{duration: 200, easing: cubicOut}}
                                ...
                                {#each groupedIssues[addonName] as issue, i (i)}
